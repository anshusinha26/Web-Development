...
app.get("/filter", function (req, res) {
    ...
    const filteredJokeType = jokes.filter((joke) => joke.jokeType === type);
    res.json(filteredJokeType);
});
...
app.put("/jokes/:id", function (req, res) {
    ...
    const searchIndex = jokes.findIndex((joke) => joke.id === id); // findIndex - to get the hold of the index to completely replace
    jokes[searchIndex] = replacementJoke;
    res.json(replacementJoke);
});

//6. PATCH a joke (small / partial update)
